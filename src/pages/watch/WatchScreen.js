        ...
        <div className="flex justify-center w-full">
            <div className="max-w-[110rem] w-full">
                <div className="w-full h-full flex justify-center ">
                    <div className="flex flex-col ml-6 mt-6 mb-2 mr-6 w-full max-w-[calc(calc(100vh-216px)*16/9)] [@media(max-width:1254px)]:min-w-[22rem] min-w-[26.8rem] lg:min-w-[40rem] app-min-md:min-w-[53.33rem]">
                        <PlayerSection id={id} />
